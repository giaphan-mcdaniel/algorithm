...
table <- table(result$cluster,iris.class)
...
correct_identifications <- sum(diag(table))

# Total number of instances:
total_cases <- length(iris.class)

# Accuracy rate of classified instances:
accuracy <- (correct_identifications / total_cases)
print(accuracy)